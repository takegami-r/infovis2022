class ParallelCoodinates {
    ...
    setLabelOrder(labelorder) {
        ...
        for (i = 0; i < labelorder.length; i++) {
            this.labelorder[i] = labelorder[i];
        }
    }
    ...
    render() {
        ...
        self.line.selectAll("line").remove();

        self.line.selectAll("line")
                  .data(self.data)
                  .enter()
                  .append("line")
                  .attr("x1",this.inner_width/3*(self.labelorder[1]-1))
                  .attr("x2",this.inner_width/3*self.labelorder[1])
                  .attr("y1",function(d) {if(self.labelorder[1]==1)return self.trafficyscale(d.traffic);
                    if(self.labelorder[1]==2)return self.temperatureyscale(d.temperature);
                    if(self.labelorder[1]==3)return self.temperatureyscale(d.temperature); })
        ...
        self.line.selectAll("line1")
                  .data(self.data)
                  .enter()
                  .append("line")
                  .attr("x1",this.inner_width/3*(self.labelorder[2]-1))
                  .attr("x2",this.inner_width/3*self.labelorder[2])
                  .attr("y1",function(d) {if(self.labelorder[2]==1)return self.trafficyscale(d.traffic);
                    if(self.labelorder[2]==2)return self.precipitationyscale(d.precipitation);
                    return self.precipitationyscale(d.precipitation); })
        ...
        self.line.selectAll("line2")
                  .data(self.data)
                  .enter()
                  .append("line")
                  .attr("x1",this.inner_width/3*(self.labelorder[3]-1))
                  .attr("x2",this.inner_width/3*self.labelorder[3])
                  .attr("y1",function(d) {if(self.labelorder[3]==1)return self.trafficyscale(d.traffic);
                    if(self.labelorder[3]==2)return self.daylightyscale(d.daylight);
                    return  self.daylightyscale(d.daylight);})
        ...
        self.chart.selectAll("circle1")
                  ...
                  .enter()
                  .append("circle")
                  .attr("cx", d => self.xscale( self.labelname[self.labelorder[1]] ))
        ...
        self.chart.selectAll("circle2")
                ...
                .enter()
                .append("circle")
                .attr("cx", d => self.xscale( self.labelname[self.labelorder[2]] ))
        ...
        self.chart.selectAll("circle3")
                ...
                .enter()
                .append("circle")
                .attr("cx", d => self.xscale( self.labelname[self.labelorder[3]] ))
